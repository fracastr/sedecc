	...
	<div class="panel-body">
		<div class="bs-example form-horizontal">
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-3">
			    	<?php echo $form->emailField($model,'eess_email',array('size'=>60,'maxlength'=>250, 'class'=>'form-control bord','multiple' => true)); ?>
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-2">
			    	<?php echo $form->textField($model,'eess_clave',array('size'=>60,'maxlength'=>200, 'class'=>'form-control bord')); ?>
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-4">
			    	<?php echo $form->emailField($model,'eess_representante_email',array('size'=>60,'maxlength'=>255, 'class'=>'form-control bord','required' => false)); ?>
