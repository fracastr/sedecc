	...
	<div class="panel-body">
		<div class="bs-example form-horizontal">
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-10">
			    	<?php echo $form->textField($model,'fae_id',array('size'=>60,'maxlength'=>255, 'class'=>'form-control')); ?>
			...
			?>
				...
				<div class="col-lg-10">
				    ...
				    <?php echo $form->dropDownList($model,'eess_rut',CHtml::listData(Eess::model()->findAll(array('order'=>'eess_nombre_corto','condition'=>'eess_estado=1')), 'eess_rut', 'eess_nombre_corto'),array('prompt'=>' ','class'=>'form-control','disabled'=>$disabled));?>
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-10">
			    	<?php echo $form->textField($model,'fae_nombre',array('size'=>60,'maxlength'=>255, 'class'=>'form-control')); ?>
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-10">
			    	...
			    	<?php echo $form->dropDownList($model,'fae_activo',array('1'=>'Activa','0'=>'Inactiva'),array('class'=>'form-control'));?>
			...
			<div class="form-group">
			    ...
			    <div class="col-lg-10">
			    	<?php echo $form->textField($model,'tipo',array('size'=>60,'maxlength'=>255, 'class'=>'form-control')); ?>
