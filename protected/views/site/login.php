...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	'clientOptions'=>array(
        ...
        <div class="col-md-10" style="background-color: #217fbd; padding:20px; -webkit-box-shadow: 10px 10px 5px -6px rgba(0,0,0,0.75); -moz-box-shadow: 10px 10px 5px -6px rgba(0,0,0,0.75); box-shadow: 10px 10px 5px -6px rgba(0,0,0,0.75); margin-bottom: 10px;">
              <span style="margin-left:10px;">Nombre de usuario</span>
			   <?php echo $form->textField($model,'username',array('placeholder'=>'Nombre de usuario (o RUT evaluador)', 'class'=>'form-control','style'=>'border-radius: 5px;')); ?>
