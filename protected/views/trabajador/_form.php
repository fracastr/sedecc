		...
		<div class="row">
			...
			?>
				...
				<?php } ?>
				    ...
				    <div class="col-lg-12">
				    	<?php echo $form->dropDownList($model,'tra_evaluador',array('0'=>'No','1'=>'Si'),array('class'=>'form-control'));?>
				    ...
				    <div class="col-lg-12" style="<?php if($model->tra_evaluador == 0) echo 'display:none;';?>">
				    	<?php echo $form->dropDownList($model,'tra_responder_todo',array('0'=>'No','1'=>'Si'),array('class'=>'form-control'));?>
				    ...
				    <div class="col-lg-12" style="<?php if($model->tra_evaluador == 0) echo 'display:none;';?>">
				    	<?php echo $form->dropDownList($model,'tra_recibir_todo',array('0'=>'No','1'=>'Si'),array('class'=>'form-control'));?>
				...
				<div class="col-md-7">
					...
					<div class="col-md-6 marg" style="<?php if($model->tra_evaluador == 0) echo 'display:none;';?>">
				    	...
				    	<?php echo $form->textField($model,'tra_color',array('class'=>'form-control')); ?>
