...
if(isset($_POST['respuesta'])){
	...
	$headers .= "Bcc: ronnymunoz22@gmail.com, sebastian.carcamo398@gmail.com, eduardoacevedo@innoapsion.cl " . "\r\n"; // 
...
<span style='float:right;'>
	...
	if((Yii::app()->user->id == $evaluador || Yii::app()->user->id == 'admin' || Yii::app()->user->id == $eess) && $model->res_seguimiento != 1) echo '
